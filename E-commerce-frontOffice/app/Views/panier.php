        ...
        <div class="body-content">
            <div class="container">
                <div class="sign-in-page">
                    <div class="row">
                        <h4 class="checkout-subtitle">Listes des produits</h4>
                        ...
                        <?php if(!empty($listePanier)) { ?>
                            <?php foreach($listePanier as $liste) { ?>
                              <tbody>
                                <tr>
                                  <td><?php echo $liste->getDesignation(); ?></td>
                                  <td><?php echo $liste->getPoidUnitaire(); ?> Kg</td>
                                  <td><?php echo $liste->getPrixUnitaire(); ?> Ar</td>
                                  <td><?php echo $liste->getQuantitePanier(); ?> Kg</td>
                                  <td><?php echo $liste->getPrixTotal(); ?> Ar</td>
                                </tr>
                              </tbody>
                            <?php } ?>
                              <tbody>
                                <tr>
                                  ...
                                  <td><b><?php echo $sommeTotal; ?> Ar</b></td>
                                  <td></td>
                                </tr>
                              </tbody>
                        <?php } ?>
                        </table>
                        <a href="<?php echo base_url(); ?>/login" class="btn btn-primary btn-lg btn-block">Valider</a>
                        <a href="<?php echo base_url(); ?>/annulationRecette?recette=recette" class="btn btn-danger btn-lg btn-block">Annuler</a>
                    </div> 	
                </div>
            </div>
        </div>
