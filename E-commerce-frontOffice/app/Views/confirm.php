        ...
        <div class="body-content">
            <div class="container">
                <div class="sign-in-page">
                    <div class="row">
                        <h4 class="checkout-subtitle">Voulez vous utiliser les produits ci-dessous ?</h4>
                        ...
                        <?php if(!empty($tabRestant)) { ?>
                            <?php foreach($tabRestant as $liste) { ?>
                              <tbody>
                                <tr>
                                  <td><?php echo $liste->getDesignation(); ?></td>
                                  <td><?php echo $liste->getQuantiteRestant(); ?></td>
                                  <td><a href="<?php echo base_url(); ?>/addPanierv2?confirm=Oui&idrecette=2" class="btn btn-primary btn-lg btn-block">Oui</a></td>
                                  <td><a href="<?php echo base_url(); ?>/addPanierv2?confirm=Non&idrecette=<?php echo $liste->getIdRecette(); ?>&idproduit=<?php echo $liste->getIdProduits(); ?>" class="btn btn-danger btn-lg btn-block">Non</a></td>
                                </tr>
                              </tbody>
                            <?php } ?>
                        <?php } ?>
