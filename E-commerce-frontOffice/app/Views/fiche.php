    ...
    <div class="row"> 
      ...
      <div class="body-content">
        ...
        <div class="sidebar-widget hot-deals outer-bottom-xs">
              <h3 class="section-title"><?php echo $produits->getDesignation(); ?></h3>
                ...
                <div class="item">
                  <div class="products">
                    <form action="<?php echo base_url(); ?>/addPanier" method="post">
                      <a href="#">
                      <img src="<?php echo $produits->getTabImagesProduits()[0]->getImages(); ?>" alt=""> 
                      </a>
                    <!-- /.hot-deal-wrapper -->
                    
                    <div class="product-info text-left m-t-20">
                      <h3 class="name">Quantité en stock <?php echo $quantite; ?></h3>
                      <div class="rating rateit-small"></div>
                      <div class="product-price"> <span class="price"> $ <?php echo $produits->getPrixUnitaire(); ?> </span>  </div>
                      <!-- /.product-price --> 
                    ...
                    <div class="cart clearfix animate-effect">
                      <div class="action">
                        ...
                        <input type="hidden" name="idproduit" value="<?php echo $produits->getIdProduits(); ?>" >
