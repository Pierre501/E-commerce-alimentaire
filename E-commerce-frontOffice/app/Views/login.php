            ...
            <div class="container">
                <div class="sign-in-page">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 sign-in">
                            ...
                            <div class="social-sign-in outer-top-xs">
                                ...
                                <a href="#" class="twitter-sign-in"><i class="fa fa-twitter"></i> Se connecter avec  Twitter</a>
                            </div>
                            <form class="register-form outer-top-xs" role="form" action="<?php echo base_url(); ?>/loginClient" method="post">
                                <div class="form-group">
                                    <label class="info-title" for="exampleInputEmail1">Nom d'utilisateur<span>*</span></label>
                                    <input type="email" name="username" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
                                </div>
                                <div class="form-group">
                                    <label class="info-title" for="exampleInputPassword1">Mot de passe<span>*</span></label>
                                    <input type="password" name="motdepasse" class="form-control unicase-form-control text-input" id="exampleInputPassword1" >
                                </div>
                                <div class="radio outer-xs">
                                    <label>
                                        <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">Souviens moi!
                                    </label>
                                    <a href="#" class="forgot-password pull-right">Oublié le mot de passe?</a>
                                </div>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        <h4 class="checkout-subtitle">Créer un nouveau compter</h4>
                        <form class="register-form outer-top-xs" role="form" action="<?php echo base_url(); ?>/inscription" method="post">
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail2">Nom <span>*</span></label>
                                <input type="text" name="nom" class="form-control unicase-form-control text-input" id="exampleInputEmail2" >
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">Prénom <span>*</span></label>
                                <input type="text" name="prenom" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">Nom d'utilisateur <span>*</span></label>
                                <input type="email" name="username" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="motdepasse" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">Adresse <span>*</span></label>
                                <input type="text" name="adresse" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
                            </div>
                            <button type="submit" class="btn-upper btn btn-primary checkout-page-button">Créer</button>
                        </form>
                    </div>	
                </div>
            </div>
