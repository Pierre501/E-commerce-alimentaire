      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
                <li class="dropdown menu-item"> <a href="<?php echo base_url(); ?>/recette" class="dropdown-toggle" ><i class="icon fa fa-align-justify" aria-hidden="true"></i>Liste des recètte</a>
            </ul>
          </nav>
          <!-- /.megamenu-horizontal --> 
        </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder" style="margin-top: -30px;"> 
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs">
          <div class="more-info-tab clearfix ">
            <h3 class="new-product-title pull-left">Nouveau produit</h3>
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">All</a></li>
              <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">Produts laitiers</a></li>
              <li><a data-transition-type="backSlide" href="#laptop" data-toggle="tab">Legumes et Fruits</a></li>
              <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Boisson</a></li>
            </ul>
            <!-- /.nav-tabs --> 
          </div>
              ...
              <div class="product-slider">
                ...
                <?php foreach($tabProduit as $produit) { ?>
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                      <?php foreach($produit->getTabImagesProduits() as $images) { ?>
                        <div class="product-image">
                          <div class="image"> 
                          <a href="<?php echo base_url(); ?>/fiche?designation=<?php echo $produit->getDesignation(); ?>">
                            <img src="<?php echo $images->getImages(); ?>" alt=""> 
                          </a> 
                       </div>
                          <!-- /.image -->
                      ...
                      <form action="<?php echo base_url(); ?>/addPanier" method="post">
                        <input type="hidden" name="idproduit" value="<?php echo $produit->getIdProduits(); ?>" >
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html" id="designation"><?php echo $produit->getDesignation(); ?></a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price" id="prixUnitaire"><?php echo $produit->getPrixUnitaire(); ?> Ar</span></div>
